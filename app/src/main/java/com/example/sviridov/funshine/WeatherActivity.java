...
public class WeatherActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    final String URl_COORDS = "/?lat=";//"/?lat=40.739542&lon=-73.991319";
    final String URL_API_KEY = "&APPID=b47469d9b74fb1ac6ccb6a84294d54ed";
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, PERMITION_LOCATION);
        } else {
        ...
        switch (requestCode) {
            case PERMITION_LOCATION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "Muahahah", Toast.LENGTH_LONG);
                }
            }
        }
    }
